...
# ## Iteration 2: Model Training, Tuning & Export (Home 2+ Goals)
# 
# ### Objective
# 
# - Train, tune, and evaluate a Random Forest classifier to predict home team scoring 2+ goals.
# - Optimize hyperparameters and classification threshold for best business value.
# - Save the trained model and feature set for future evaluation.
# 
# ---
# 
# ### Steps Performed
...
# - Used the cleaned and engineered training dataset.
# - Target variable: `Home_2plus`.
# - Dropped potential leakage and redundant columns via `cols_to_drop`.
# - Performed grid search (`GridSearchCV`) over 24 combinations of hyperparameters:
#   - `n_estimators`: [100, 200]
#   - `max_depth`: [None, 5, 10, 20]
#   - `min_samples_split`: [2, 5, 10]
# - Scored on F1 (harmonizing precision and recall).
# 
# **2. Model Evaluation**
# - Best RF parameters: `{'max_depth': 5, 'min_samples_split': 2, 'n_estimators': 200}`
# - Best cross-validated F1-score: **0.53**
# - Test set classification report (default threshold):
#     - Class 0: precision 0.64, recall 0.78, f1 0.70
#     - Class 1: precision 0.63, recall 0.46, f1 0.53
#     - **Accuracy:** 0.64
# 
# **3. Threshold Optimization**
# - Computed precision-recall-F1 curve for predicted probabilities.
# - Chose best F1 threshold: **0.350**
# - Performance at optimal threshold:
#     - Class 0: precision 0.76, recall 0.32, f1 0.45
#     - Class 1: precision 0.51, recall 0.87, f1 0.64
#     - **Accuracy:** 0.57
#     - **Best F1-score:** 0.64 (at threshold 0.35)
#     - Tradeoff: Higher recall for positives at cost of precision.
# 
# - Displayed feature importance for top 20 predictors and visualized precision/recall/F1 curves vs. threshold.
# 
# **4. Model Export**
# - Saved the best Random Forest model (`rf_Home_2plus_best.pkl`).
# - Saved the feature list (`rf_Home_2plus_feature_list.pkl`) for future alignment.
# - Saved the cleaned evaluation DataFrame for downstream scoring.
# 
# ---
# 
# ### Result
# 
# - Trained and tuned Random Forest model for "Home 2+ goals" prediction, with hyperparameters and threshold optimized for business value.
# - Exported model and feature list for use in subsequent evaluation pipelines.
# - Business-driven threshold selection demonstrated, balancing recall and precision.
# 
# ---
